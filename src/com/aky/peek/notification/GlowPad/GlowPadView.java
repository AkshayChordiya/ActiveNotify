...
package com.aky.peek.notification.GlowPad;
...
public class GlowPadView extends View {
	...
	public void setVibrationDuration(int mVibrationDuration) {
		this.mVibrationDuration = mVibrationDuration;
	}
	
	public void setCloud(boolean mCloud) {
		this.mCloud = mCloud;
	}
	
	public void setOuterRing(boolean mOuterRing) {
		this.mRing = mOuterRing;
	}
	...
	public void setHandleDrawable(Drawable paramDrawable){
	    this.mHandleDrawable.setDrawable(paramDrawable);
	}
	
	public boolean replaceTargetDrawablesByPosition(Resources mResources, int paramInt1, int paramInt2){
	    boolean bool;
	    if (paramInt2 == 0)
	      bool = false;
	    else{
	    	TargetDrawable localTargetDrawable = (TargetDrawable)this.mTargetDrawables.get(paramInt1);
	    	bool = false;
	    	if (localTargetDrawable != null){
	    		localTargetDrawable.setDrawable(mResources, paramInt2);
	    		bool = true;
	    	}
	    	if (bool)
	    		requestLayout();
	...
	public boolean replaceTargetDrawablesByPosition(Drawable mDrawable, int paramInt){
		boolean bool;
		if (mDrawable == null)
			bool = false;
		else{
			...
			bool = false;
			if (localTargetDrawable != null){
				localTargetDrawable.setDrawable(mDrawable);
				bool = true;
			}
			if (bool)
				requestLayout();
