...
public class DialogCreator {
    ...
    public DialogCreator(final Context context) {
        mContext = context;
    }
    ...
    public DialogCreator setOnDismissListener(final DialogInterface.OnDismissListener onDismissListener) {
    ...
    protected void show(final int version) {
        ...
        //Get dialog title	        	
        String title = resources.getString(R.string.about_changelog_title);
        ...
        //Get button strings
        final String closeString = resources.getString(android.R.string.ok);
