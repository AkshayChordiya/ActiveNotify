...
public final class SeekBarPreference extends DialogPreference implements OnSeekBarChangeListener {
    ...
    private static final String PREFERENCE_NS = "http://schemas.android.com/apk/res/com.aky.peek.notification";
    ...
    protected View onCreateDialogView() {
    	...
    	View view = inflater.inflate(R.layout.calibrate_slider, null);
    ...
    public void onProgressChanged(SeekBar seek, int value, boolean fromTouch) {
    	...
    	mValueText.setText(Integer.toString(mCurrentValue));
    	if(getKey().contentEquals("glowpad_vibrate")){
    		if(value == 0)
    		// Update label with current value
        	mValueText.setText("No Vibration");
    	}
    	else if(getKey().contentEquals("custom_timeout")){
    		if(value >= 60){
    			float value_mins = mCurrentValue / 60;
    			mValueText.setText(Float.toString(value_mins) + " mins");
    		}
    	}
    }
